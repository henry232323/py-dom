...
class AwesomeCard(Element):
    ...
    @property
    def children(self):
        return [div(_class='col s6', style=dict(padding=2))(div(_class='card blue-grey darken-1')(
            div(_class='card-content white-text')(span(_class='card-title')(f'Card Title {self.buttonValue}'),
